...
<head>
	...
	<link rel="stylesheet" href="../styles/lawyerHome.css">
...
<body>
	<form method="post" action="../controllers/lawyerHomeController.php">
		<div class="nav">
			<div class="logo">
				<h2>E-LawyerBD</h2>
			</div>
	...
	<div class="welcomeText">
			<h1>Welcome to Lawyer Portal, <?php echo $_SESSION['name'].'.';?><br>
				Your user-ID : <?php echo $_SESSION['id'];?><br>
				Your rating : <?php echo $_SESSION['RATING'];?></h1>
	</div>
</body>
</html>