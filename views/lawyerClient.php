...
<head>
	...
	<link rel="stylesheet" href="../styles/lawyerClient.css">
...
<body>
	<form method="post" action="../controllers/lawyerClientController.php">
		<div class="nav">
			<div class="logo">
				<h2>E-LawyerBD</h2>
			</div>
					...
					<table>
						...
						<tbody>
							<?php while($r = $res->fetch_assoc()){
										...
										$exists = in_array($clientID, $clientIDs);
										if($exists){
											continue;
										}
										else{
