...
<head>
	...
	<link rel="stylesheet" href="../styles/adminLawyer.css">
		...
		<div class="content">
			<div class="table">
				<section class="tableHeader">
					<div class="tableName"><h1>Lawyers</h1></div>
				...
				<div class="msg">
					<p><?php
						if(isset($_SESSION['lawyerTableMsg'])){
							echo $_SESSION['lawyerTableMsg'];
							unset($_SESSION['lawyerTableMsg']);
						}?></p>
				</div>
