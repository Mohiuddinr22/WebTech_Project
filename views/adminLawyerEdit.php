<?php
	...
	$id = $_SESSION['editLawyerID'];
	$res = loadLawyerDetails($id);
	$r = $res->fetch_assoc();
?>
...
<head>
	...
	<link rel="stylesheet" href="../styles/adminLawyerEdit.css">
...
<body>
	<form method="post" action="../controllers/adminLawyerTableController.php">
		<div class="nav">
			<div class="logo">
				<h2>E-LawyerBD</h2>
			</div>
		...
		<div class="content">
			<div class="editInfo">
				<h1>Update Lawyer Details</h1><br>
				<input type="text" placeholder="User-ID" name="id" value="<?php echo $r['ID'];?>" readonly><br>
				<input type="text" placeholder="BCN" name="bcn" value="BCN : <?php echo $r['BCN'];?>" maxlength="10" readonly><br>
				...
				<input type="text" placeholder="CFPH" name="cfph" value="<?php echo $r['CFPH']?>" maxlength="4"><br>
				<input type="text" placeholder="Rating" name="rating" value="Rating : <?php echo $r['Rating']?>" maxlength="1" readonly><br>
