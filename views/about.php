...
<body>
	<form method="post" action="../controllers/homeController.php">
		...
		<div class="content">
			<h1 style="margin: 0px 30px;">Unlock expert legal advice at your fingertips with E-LawyerBD—your trusted partner for fast, affordable, and reliable legal solutions anytime, anywhere!</h1>
		</div>
	</form>
</body>
</html>